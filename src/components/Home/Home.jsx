...
import "./Home.css";
import SimpleMenu from '../Button-nav/Button'
      ...
      <div>
        ...
        <section className="add-padding add-flex">
          <div className="center-text">
            <h1 className="alex-brush">
              <span className="custom-font">Descubre</span>
              <br />
              nuestra historia
            </h1>
            <h2>*</h2>
            <p>
              Aquí te inventas una película sobre el restaurante en plan traemos
              el mejor caldo desde crevillente y estamos dotados de un gran
              equipo bla bla bla... y se supone que la foto de bajo pones una
        ...
        <section className="bread-background center-h1">
          <h1 className="custom-h1 alex-brush">
            <span className="custom-font">Menús</span>
            <br />
            diarios{" "}
          </h1>
        </section>
        ...
        <section className="menu add-flex add-padding">
          ...
          <div className="center-text">
            <h1>
              <span className="custom-font alex-brush">Nuestra</span>
              <br />
              Carta
            </h1>
            <h2>*</h2>
            <p>
              Aquí les vendemos una cocina fusión entre tabarca,elche y la bahía
              de sp que bla bla blabla y arriba ponemos una fotos vacilonas de
              los platos
            </p>
            <a href="#">Ver carta</a>
          </div>
        ...
        <section className="add-flex reservation-section">
          <div className="center-text add-padding">
            <h1>
              <span className="custom-font alex-brush">Platos</span>
              <br />
              de temporada
            </h1>
            <h2>*</h2>
            <p>
              aquí pues lo que veas o metes los platos estrella o platos de
              temporada o pones el menu del día o menu de grupos vamos lo que
              gustes papi ;){" "}
            </p>
        ...
        <footer>
          ...
          <div className="copyright">
            <p>
              <small>
                Copyright 2021 &#169; Handcrafted with love by Chipiriguino
              </small>
            </p>
          </div>
        </footer>
